<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="商品种类" prop="shangpinzhonglei">
					<el-input v-model="ruleForm.shangpinzhonglei" placeholder="商品种类" clearable  :readonly="ro.shangpinzhonglei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="商品种类" prop="shangpinzhonglei">
					<el-input v-model="ruleForm.shangpinzhonglei" placeholder="商品种类" readonly></el-input>
				</el-form-item>
			</template>
